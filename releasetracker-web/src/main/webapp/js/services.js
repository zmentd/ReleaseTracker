...
angular.module('processReportService', ['ngResource']).
    factory('ProcessReport', function($resource){
  return $resource('http://localhost:8080/processreport/v1/getReport', {}, {
...
(function () {
    ...
    function AuthenticationService($http, $cookieStore, $rootScope, $timeout) {
        ...
        function Login(username, password, callback) {
        	...
        	$http({
        	    url: '/authenticator/v1/authenticate',
        	    dataType: 'json',
        	    method: 'POST',
